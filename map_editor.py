...
img = [
cv2.imread("image_penpen/chip00.png"),
cv2.imread("image_penpen/chip01.png"),
cv2.imread("image_penpen/chip02.png"),
cv2.imread("image_penpen/chip03.png")
]

for i in range(4):
    x=0
    y=0
    path = "image_gl\CHAR.png"
    img[i] = cv2.imread(path)
    #cropped_image = img[x*16:y*16, x*16+15:y*16+15]
    #img[i] = img
